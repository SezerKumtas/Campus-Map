...
lyr_BINA_A_16.set('fieldLabels', {'Shape_Leng': 'no label', 'Shape_Area': 'no label', 'OBN': 'header label - visible with data', });
lyr_BINA_17.set('fieldLabels', {'Shape_Leng': 'no label', 'OBN': 'no label', });
